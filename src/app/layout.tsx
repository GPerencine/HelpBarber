...
export const metadata: Metadata = {
  ...
  description:
    'Plataforma avançada para gestão de barbearias com recomendações de estilo personalizadas via Inteligência Artificial.',
  keywords: [
    'Next.js',
    'Firebase',
    'IA Generativa',
...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR" className={cn('h-full font-sans', ptSans.variable)} suppressHydrationWarning>
      <body className={cn('h-full bg-background antialiased')}>
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
          enableSystem
