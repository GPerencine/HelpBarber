    ...
    >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-semibold">
                        {format(new Date(app.startTime), "EEEE, d 'de' MMMM 'de' yyyy", {
                          locale: ptBR,
                        })}
                      </p>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Você tem certeza que deseja cancelar seu horário para{' '}
            <span className="font-bold">{appointmentToCancel?.serviceName}</span> com{' '}
            <span className="font-bold">{appointmentToCancel?.barberName}</span> em{' '}
            <span className="font-bold">
              {appointmentToCancel &&
                format(new Date(appointmentToCancel.startTime), "d 'de' MMMM 'às' HH:mm", {
                  locale: ptBR,
                })}
            </span>
