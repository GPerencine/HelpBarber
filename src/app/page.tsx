...
const features = [
  {
    ...
    description:
      'Marque horários em tempo real com confirmação instantânea. Sem ligações, sem espera.',
  },
  {
    icon: Sparkles,
    title: 'Consultor de Estilo IA',
    description:
      'Recomendações personalizadas de corte e estilo usando Inteligência Artificial Gemini.',
  },
  {
    icon: MapPin,
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom-10 duration-700 delay-500">
              <Button
                asChild
                size="lg"
                className="h-14 px-8 text-lg font-black premium-gradient shadow-xl shadow-primary/30 group"
              >
                <Link href="/cadastro">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="h-14 px-8 text-lg font-bold border-2 group"
              >
                <Link href="/login">
                  Já tenho conta
      ...
      <section className="container px-4 py-20 sm:py-28">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, i) => (
            <Card
              key={feature.title}
              className="group border border-border/50 bg-card/60 backdrop-blur-sm card-hover"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-black tracking-tighter mb-6">
                Por que escolher o <span className="text-primary">HelpBarber</span>?
              </h2>
              <p className="text-lg text-muted-foreground mb-8">
                Chega de ligar para agendar horário. Com o HelpBarber, você tem controle total da
                sua experiência de estilo.
              </p>
                  ...
                  <div className="space-y-4 text-sm">
                    ...
                    <div className="p-4 rounded-xl bg-primary/5 border border-primary/20">
                      ...
                      <p className="font-medium">
                        Corte Textured Crop — ideal para rostos ovais com cabelo ondulado. Moderno,
                        versátil e de fácil manutenção.
                      </p>
                    </div>
                  </div>
                </CardContent>
          ...
          <CardContent className="p-8 sm:p-12 lg:p-16 text-center relative">
            ...
            <div className="relative">
              ...
              <p className="text-lg opacity-90 max-w-2xl mx-auto mb-8">
                Gerencie seus agendamentos, conquiste mais clientes e tenha visibilidade na
                plataforma que mais cresce no setor.
              </p>
              <Button
                asChild
                size="lg"
                variant="secondary"
                className="h-14 px-8 text-lg font-black group"
              >
                <Link href="/cadastro">
        ...
        <div className="container px-4 py-10">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-muted-foreground text-center">
              Projeto de Extensão Universitária · USCS — Universidade Municipal de São Caetano do
              Sul
            </p>
