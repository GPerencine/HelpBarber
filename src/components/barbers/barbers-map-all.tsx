...
export default function BarbersMapAll({ barbers, className }: BarbersMapAllProps) {
  ...
  if (!mapApiKey) {
    return (
      <Alert
        variant="destructive"
        className={cn(
          'h-[400px] sm:h-[500px] flex flex-col items-center justify-center text-center',
          className,
        )}
      >
  ...
  if (!isLoaded)
    return (
      <div
        className={cn(
          'h-[400px] sm:h-[500px] w-full flex flex-col items-center justify-center bg-muted animate-pulse rounded-lg',
          className,
        )}
      >
  ...
  return (
    <div
      className={cn(
        'h-[400px] sm:h-[500px] w-full rounded-lg shadow-inner border overflow-hidden',
        className,
      )}
    >
      <GoogleMap
