...
const reviewFormSchema = z.object({
  comment: z
    .string()
    .min(10, 'Sua avaliação deve ter pelo menos 10 caracteres.')
    .max(500, 'Sua avaliação não pode ter mais de 500 caracteres.'),
  rating: z
    .number()
    .min(1, 'A avaliação deve ser de no mínimo 1 estrela.')
    .max(5, 'A avaliação deve ser de no máximo 5 estrelas.'),
});
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea
                            placeholder={`Deixe sua avaliação para este barbeiro...`}
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
        ...
        <div className="space-y-6 pt-6 border-t">
          {areReviewsLoading ? (
            ...
            <p className="text-sm text-muted-foreground text-center py-8">
              Ainda não há avaliações para este barbeiro. Seja o primeiro!
            </p>
          )}
        </div>
      </CardContent>
